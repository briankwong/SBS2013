...
\subfloat[High Frequencies\label{fig:heatmap:high}]{\includegraphics[width=.48\textwidth]{img/heatMap_1_201106.eps}}\hfill
\subfloat[Medium Frequencies\label{fig:heatmap:med}]{\includegraphics[width=.48\textwidth]{img/heatMap_2_201106.eps}}\\
\subfloat[Low Frequencies\label{fig:heatmap:low}]{\includegraphics[width=.48\textwidth]{img/heatMap_3_201106.eps}}\hfill
\subfloat[Residual data\label{fig:heatmap:res}]{\includegraphics[width=.48\textwidth]{img/heatMap_4_201106.eps}}
