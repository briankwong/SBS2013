...
The authors of~\cite{brown:buildperf2012} use kernel regression to forecasts device consumption and devices that behave differently 
...
These approaches are highly effective for buildings that have rarely-occupied rooms (e.g. conference room) and studies show that such approaches
 can achieves up to 42\% annual energy saving.
