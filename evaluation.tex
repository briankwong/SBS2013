...
ocated in the same room. % and the unwanted data is captured at the other frequencies.
...
For each experiment, the data is split in time bins of one day, starting from 09:00 am -- which is approximately 
...
However, 36 alarms were discarded as because of sensor errors; one GHP has missing data for the first 18 days.
