...
% %Occupancy &Move to the related work section?
% Although no occupancy model is involved in the proposed approach, our experiments revealed that the building occupancy is indirectly monitored by certain devices that betray the presence of humans (e.g. the elevator in the Cory Hall). 
% The inconsistencies between the devices usage and the occupancy are highlighted by broken relationships with these devices and stands for obvious electricity wastes.
