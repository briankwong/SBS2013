...
In this paper we present a new approach, called the Strip, Bind and Search (SBS) method for uncovering abnormalities in equipment behavior and in-concert usage.
...
We demonstrate that, in many cases, SBS uncovers misbehaviors corresponding to inefficient device usage that leads to energy waste.  
