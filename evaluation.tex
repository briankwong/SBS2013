...
The Strip and Bind part of SBS is evaluated using the data from the Eng. Bldg 2. %, since we can verify how items are being used and use it as ground truth.
