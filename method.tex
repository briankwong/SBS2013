...
The proposed correlation estimator addresses this issue by decomposing each signal into a set of components, called IMF, that reveal the data structures at different time scales.
