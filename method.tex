...
are ignored by the median operator thanks to its robustness to outliers.  
However, if that assumption does not hold, our model will flag the opposite -- labeling abnormal as normal and vice-versa.
