...
The research community has addressed the detection of buildings abnormal energy-consumption in numerous ways.
...
% 
For example, by monitoring the average and peak daily consumption of a building and uncovering outlier values, abnormal consumption is systematically uncovered \cite{seem:energybldg2007}.
...
Thereby, the devices consumption is modeled using the Fourier transform and outliers are detected using clustering techniques \cite{Bellala_buildsys11,wrinch:pes2012,chen:aaaiw2011}. %jakkula
